...
def get_dataset(dataset_name, M_view, N_view, root='../data', pair=True):
    if pair:
        if dataset_name=='cifar10':
            train_data = CIFAR10Pair(root=root, train=True, transform=test_transform, download=True)
            ...
            train_data = CIFAR100Pair(root=root, train=True, transform=test_transform, download=True)
            ...
            train_data = STL10Pair(root=root, split='train', transform=test_transform, download=True)
            ...
            train_data = CIFAR100Pair_true_label(root=root, train=True, transform=test_transform)
